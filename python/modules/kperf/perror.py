...
class Error:
    ...
    LIBPERF_ERR_INVALID_PMU_DEVICES_METRIC = 1049
    LIBPERF_ERR_INVALID_PMU_DEVICES_BDF = 1050
    LIBPERF_ERR_OPEN_INVALID_FILE = 1051
    LIBPERF_ERR_INVALID_BDF_VALUE = 1052
    LIBPERF_ERR_NOT_SOUUPUT_PCIE_BDF = 1053
    LIBPERF_ERR_NOT_SOUUPUT_SMMU_BDF = 1054
    LIBPERF_ERR_INVALID_IOSMMU_DIR = 1055
    LIBPERF_ERR_INVALID_SMMU_NAME = 1056
    LIBPERF_ERR_NOT_SOUUPUT_PCIE_COUNTING = 1057
    LIBPERF_ERR_OPEN_PCI_FILE_FAILD = 1058
    LIBPERF_ERR_INVALID_MTRIC_PARAM = 1059
    LIBPERF_ERR_PMU_DEVICES_NULL = 1060
